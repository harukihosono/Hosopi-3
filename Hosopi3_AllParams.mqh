//+------------------------------------------------------------------+
//|                  Hosopi 3 - 全パラメータ定義（統合版）           |
//|                              Copyright 2025                      |
//|               MQL4/MQL5共通パラメーター定義ファイル                |
//+------------------------------------------------------------------+
...
// MQL5はsinput groupを使用、MQL4は通常のinput stringでセクション分け
#ifdef __MQL5__
   #define SECTION_GROUP(x) sinput group x
   #define SECTION_TITLE(var, title) input string var = ""; input string var##_Title = "★━━━ " title " ━━━★"; input string var##_Space1 = ""; input string var##_Space2 = ""
   #define SECTION_SPACER(var) input string var = ""
#else
   #define SECTION_GROUP(x) 
   #define SECTION_TITLE(var, title) input string var = ""; //+--- ★━━━ title ━━━★ ---+ \
                                     input string var##_Space1 = ""; \
                                     input string var##_Space2 = ""
   #define SECTION_SPACER(var) input string var = ""
#endif
...
//==================================================================
SECTION_GROUP("== 基本設定 ==")
SECTION_TITLE(BasicSettings, "基本的なEA動作設定")
SECTION_SPACER(BasicSettings_Spacer)
...
//                    ナンピンマーチン設定
//==================================================================
SECTION_GROUP("== ナンピン・マーチン設定 ==")
SECTION_TITLE(NanpinSettings, "ナンピンマーチンゲール設定")
SECTION_SPACER(NanpinSettings_Spacer)
...
//                    トレーリング設定
//==================================================================
SECTION_GROUP("== トレーリング設定 ==")
SECTION_TITLE(TrailingSettings, "トレーリングストップ設定")
SECTION_SPACER(TrailingSettings_Spacer)
...
//                    資金管理設定
//==================================================================
SECTION_GROUP("== 資金管理設定 ==")
SECTION_TITLE(RiskManagement, "資金管理・リスク制御設定")
SECTION_SPACER(RiskManagement_Spacer)
...
//                    ゴーストエントリー設定
//==================================================================
SECTION_GROUP("== ゴーストエントリー設定 ==")
SECTION_TITLE(GhostSettings, "ゴーストエントリー機能設定")
SECTION_SPACER(GhostSettings_Spacer)
...
//                    時間フィルター設定
//==================================================================
SECTION_GROUP("== 時間フィルター設定 ==")
SECTION_TITLE(TimeFilter, "時間帯・曜日制御設定")
SECTION_SPACER(TimeFilter_Spacer)
...
//                    偶数奇数戦略設定
//==================================================================
SECTION_GROUP("== 偶数奇数時間戦略 ==")
SECTION_TITLE(EvenOddStrategy, "偶数奇数時間戦略設定")
SECTION_SPACER(EvenOddStrategy_Spacer)
...
// 戦略エントリー条件設定
SECTION_GROUP("== 戦略エントリー条件 ==")
SECTION_TITLE(StrategyCondition, "戦略エントリー条件設定")  
SECTION_SPACER(StrategyCondition_Spacer)
input STRATEGY_ENTRY_CONDITION Strategy_Entry_Condition = STRATEGY_NO_SAME_DIRECTION; // 戦略エントリー条件

// 移動平均線（MA）戦略設定
SECTION_GROUP("== 移動平均線戦略 ==")
SECTION_TITLE(MAStrategy, "移動平均線戦略設定")
SECTION_SPACER(MAStrategy_Spacer)
...
// RSI戦略設定
SECTION_GROUP("== RSI戦略 ==")
SECTION_TITLE(RSIStrategy, "RSI戦略設定")
SECTION_SPACER(RSIStrategy_Spacer)
...
// ボリンジャーバンド戦略設定
SECTION_GROUP("== ボリンジャーバンド戦略 ==")
SECTION_TITLE(BBStrategy, "ボリンジャーバンド戦略設定")
SECTION_SPACER(BBStrategy_Spacer)
...
// RCI戦略設定
SECTION_GROUP("== RCI戦略 ==")
SECTION_TITLE(RCIStrategy, "RCI戦略設定")
SECTION_SPACER(RCIStrategy_Spacer)
...
// ストキャスティクス戦略設定
SECTION_GROUP("== ストキャスティクス戦略 ==")
SECTION_TITLE(StochStrategy, "ストキャスティクス戦略設定")
SECTION_SPACER(StochStrategy_Spacer)
...
// CCI戦略設定
SECTION_GROUP("== CCI戦略 ==")
SECTION_TITLE(CCIStrategy, "CCI戦略設定")
SECTION_SPACER(CCIStrategy_Spacer)
...
// ADX戦略設定
SECTION_GROUP("== ADX戦略 ==")
SECTION_TITLE(ADXStrategy, "ADX戦略設定")
SECTION_SPACER(ADXStrategy_Spacer)
...
// テクニカル指標条件判定設定
SECTION_GROUP("== 条件判定設定 ==")
SECTION_TITLE(Condition, "複数指標条件判定設定")
SECTION_SPACER(Condition_Spacer)
input CONDITION_TYPE Indicator_Condition_Type = OR_CONDITION; // 複数指標の条件判定方法

//==================================================================
//                  常時エントリー戦略設定
//==================================================================
SECTION_GROUP("== 常時エントリー設定 ==")
SECTION_TITLE(ConstantEntry, "常時エントリー戦略設定")
SECTION_SPACER(ConstantEntry_Spacer)
...
//                  テクニカルフィルター設定
//==================================================================
SECTION_GROUP("== テクニカルフィルター設定 ==")
SECTION_TITLE(TechnicalFilter, "テクニカルフィルター設定")
SECTION_SPACER(TechnicalFilter_Spacer)
...
//                        表示設定
//==================================================================
SECTION_GROUP("== 表示・GUI設定 ==")
SECTION_TITLE(DisplaySettings, "画面表示・GUI設定")
SECTION_SPACER(DisplaySettings_Spacer)
...
//==================================================================
SECTION_GROUP("== 通知設定 ==")
SECTION_TITLE(Notification, "アラート・通知設定")
SECTION_SPACER(Notification_Spacer)
...
//==================================================================
SECTION_GROUP("== 高度な設定 ==")
SECTION_TITLE(AdvancedSettings, "高度な機能設定")
SECTION_SPACER(AdvancedSettings_Spacer)
...
// 個別ロット設定
SECTION_GROUP("== 個別ロット指定 ==")
SECTION_TITLE(IndividualLot, "ポジション別個別ロット指定")
SECTION_SPACER(IndividualLot_Spacer)
...
// 個別ナンピン幅設定
SECTION_GROUP("== 個別ナンピン幅指定 ==")
SECTION_TITLE(IndividualSpread, "ポジション別個別ナンピン幅指定")
SECTION_SPACER(IndividualSpread_Spacer)
...
// 個別利確幅設定
SECTION_GROUP("== 個別利確幅指定 ==")
SECTION_TITLE(IndividualTP, "ポジション数別個別利確幅指定")
SECTION_SPACER(IndividualTP_Spacer)
...
SECTION_GROUP("== 曜日別時間指定 ==")
SECTION_TITLE(DayTime, "曜日別詳細時間指定")
SECTION_SPACER(DayTime_Spacer)
